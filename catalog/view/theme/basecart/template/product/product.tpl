        ...
        <div class="row justify-content-between">
                        ...
                        <div class="col-2 p-0">
                            ...
                            <div class="thumb-small-slider">
                                ...
                                <div class="image-additional">
                                    ...
                                    <img class="img-fluid" src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
                                    <!-- </a> -->
                                </div>
            ...
            <div class="col-4">
                <div class="card border-0 card-prod-info">
                    <div class="card-body bg-info px-3 text-center border border-top-0">
                        <!-- 
                    ...
                    -->
                        <p class="card-title h6"><strong><?php echo $heading_title; ?></strong></p>
                        ...
                        <?php } ?>
                        <ul class=" list-group product-data" hidden>
                            <?php if ($manufacturer) { ?>
                            <li class="list-group-item "><span class="sp "><?php echo $text_manufacturer; ?></span>
                                <a href="<?php echo $manufacturers; ?>">
                                    <?php echo $manufacturer; ?>
                                </a>
                            </li>
                            <?php } ?>
                            <li class="list-group-item"><span class="sp"><?php echo $text_model; ?></span>
                                <?php echo $model; ?>
                            </li>
                            <?php if ($reward) { ?>
                            <li class="list-group-item"><span class="sp"><?php echo $text_reward; ?></span>
                                <?php echo $reward; ?>
                            </li>
                            <?php } ?>
                            <li class="list-group-item"><span class="sp"><?php echo $text_stock; ?></span>
                                <?php echo $stock; ?>
                            </li>
                        </ul>
                        ...
                        <div id="product">
                            ...
                            <div hidden class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
